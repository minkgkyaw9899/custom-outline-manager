...
export const MOCK_SERVERS: MockServer[] = [
  {
    ...
    spark: [
      46, 38, 52, 44, 60, 41, 35, 55, 48, 62, 40, 50, 43, 58, 36, 47, 53, 39,
      45, 57, 42, 49, 88, 71,
    ],
  },
  {
    ...
    spark: [
      34, 42, 38, 50, 45, 36, 54, 40, 47, 33, 58, 44, 39, 52, 46, 37, 49, 55,
      41, 48, 35, 43, 72, 92,
    ],
  },
  {
    ...
    spark: [
      40, 62, 44, 36, 58, 47, 33, 55, 42, 51, 38, 60, 45, 34, 53, 48, 39, 56,
      43, 50, 37, 46, 90, 78,
    ],
  },
  {
    ...
    spark: [
      58, 41, 47, 39, 53, 45, 36, 50, 43, 56, 38, 48, 34, 52, 44, 40, 55, 37,
      49, 42, 46, 35, 86, 64,
    ],
  },
  {
    ...
    spark: [
      32, 45, 38, 51, 36, 48, 41, 55, 34, 46, 39, 52, 43, 37, 50, 44, 35, 49,
      40, 53, 42, 47, 68, 84,
    ],
  },
  {
    ...
    spark: [
      44, 51, 39, 57, 42, 48, 35, 54, 46, 38, 59, 43, 50, 36, 52, 45, 40, 56,
      41, 47, 34, 49, 82, 74,
    ],
  },
]
